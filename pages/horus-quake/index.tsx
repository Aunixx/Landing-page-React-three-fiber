  ...
  return (
   ...
   "
      ...
      <MarketPlaceDetail
        ...
        set="SIGMA CLASS"
        rarity="COMMON"
        desc='Horus Quake was the first-ever "Common" vehicle produced for the Sigma class by the Amenthes nation. Its well-balanced stats give a competitive edge for racing on tracks that contain both straight-line stretches as well as twists and turns.'
        price="Buy &nbsp; $99.99"
        stats="Car Statistics"
        strengthNum="5.5"
        strengthTitle="Handling"
        tvLink="https://terravirtua.io/marketplace/nitro_hqx600"
        img={awsAssetsFetcher("horus-quake-bnr")}
        statsImg={awsAssetsFetcher("horus-quake-model")}
        videoImg={awsAssetsFetcher("horus-video-model")}
        videoUrl={videoUrl}
        carStats={carStats}
        features={features}
        strengthDesc={
